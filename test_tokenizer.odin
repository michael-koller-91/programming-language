...
test_tokenize_src_01 :: proc(t: ^testing.T) {
	...
	testing.expect_value(t, tokens[0].kind, Token_Kind.Identifier)
	testing.expect_value(t, tokens[1].kind, Token_Kind.L_Par)
	testing.expect_value(t, tokens[2].kind, Token_Kind.Integer)
	testing.expect_value(t, tokens[3].kind, Token_Kind.Add)
	testing.expect_value(t, tokens[4].kind, Token_Kind.Integer)
	testing.expect_value(t, tokens[5].kind, Token_Kind.R_Par)
	testing.expect_value(t, tokens[6].kind, Token_Kind.Identifier)
	testing.expect_value(t, tokens[7].kind, Token_Kind.L_Par)
	testing.expect_value(t, tokens[8].kind, Token_Kind.Identifier)
	testing.expect_value(t, tokens[9].kind, Token_Kind.L_Par)
	testing.expect_value(t, tokens[10].kind, Token_Kind.R_Par)
	testing.expect_value(t, tokens[11].kind, Token_Kind.R_Par)
	testing.expect_value(t, tokens[12].kind, Token_Kind.EOF)
...
test_tokenize_src_02 :: proc(t: ^testing.T) {
	...
	testing.expect_value(t, tokens[0].kind, Token_Kind.EOF)
